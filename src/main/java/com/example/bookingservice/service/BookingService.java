...
import com.example.bookingservice.api.mapper.BookingMapper;
import com.example.bookingservice.model.Booking;
import com.example.bookingservice.model.BookingStatus;
import com.example.bookingservice.support.NotFoundException;
...
public class BookingService {
	...
	public BookingService(BookingRepository bookingRepository, BlockRepository blockRepository, AvailabilityPolicy availabilityPolicy, BookingMapper bookingMapper, MessageSource messageSource) {
	...
	public Booking createBooking(Booking booking) {
		...
		availabilityPolicy.ensureBookingDatesAvailable(
			booking.getPropertyId(), booking.getStartDate(), booking.getEndDate(), null);
	...
	public Booking updateBooking(UUID id, BookingDtos.UpdateRequest update) {
		...
		availabilityPolicy.ensureBookingDatesAvailable(existing.getPropertyId(), existing.getStartDate(), existing.getEndDate(), existing.getId());
