...
import com.example.bookingservice.service.BlockService;
...
public class BlockController {
	...
	public ResponseEntity<BlockDtos.Response> create(@Valid @RequestBody BlockDtos.CreateOrUpdateRequest req) {
		Block toCreate = new Block();
		toCreate.setPropertyId(req.propertyId());
		toCreate.setStartDate(req.startDate());
		toCreate.setEndDate(req.endDate());
		Block created = blockService.createBlock(toCreate);
